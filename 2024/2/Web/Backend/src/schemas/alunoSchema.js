...
const alunoSchema = [
  ...
  body('RA').isInt().withMessage('RA deve ser um número inteiro.').notEmpty().withMessage('RA é obrigatório.'),
  ...
  body('data_nascimento').optional().isDate().withMessage('Data de nascimento deve ser uma data válida.'),

  body('genero').optional().isString().withMessage('Gênero deve ser uma string.'),
  ...
  body('documento_identidade')
    ...
    .notEmpty()
    .withMessage('Documento de identidade é obrigatório.'),
  ...
  body('data_matricula').optional().isDate().withMessage('Data de matrícula deve ser uma data válida.'),

  body('numero_matricula').optional().isString().withMessage('Número de matrícula deve ser uma string.'),

  body('id_curso').optional().isInt().withMessage('ID do curso deve ser um número inteiro.'),

  body('id_turma').optional().isInt().withMessage('ID da turma deve ser um número inteiro.'),
